...
def run_spark_job(spark):
    ...
    df = spark \
        ...
        .option("subscribe", "finalproject.calldapolice") \
    ...
    distinct_table = service_table \
        .select('original_crime_type_name', 'disposition', psf.to_timestamp(psf.col('call_date_time')).alias('calldatetime')) \
        .distinct() \
        .withWatermark('calldatetime', "60 minute")
